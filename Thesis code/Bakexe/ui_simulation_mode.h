...
public:
    ...
    void setupUi(QDialog *Simulation_mode)
    {
        ...
        explore_mode_5 = new QRadioButton(Simulation_mode);
        explore_mode_5->setObjectName("explore_mode_5");

        verticalLayout->addWidget(explore_mode_5);
    ...
    void retranslateUi(QDialog *Simulation_mode)
    {
        ...
        explore_mode_2->setText(QCoreApplication::translate("Simulation_mode", "Greedy BFS", nullptr));
        explore_mode_5->setText(QCoreApplication::translate("Simulation_mode", "A*", nullptr));
