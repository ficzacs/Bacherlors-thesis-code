...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        Delay_output_data = new QLabel(centralwidget);
        Delay_output_data->setObjectName("Delay_output_data");

        verticalLayout_4->addWidget(Delay_output_data);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        Delay_output_data->setText(QString());
        Ex_rand_walk->setText(QCoreApplication::translate("MainWindow", "Random walk", nullptr));
        Ex_rand_walkmem->setText(QCoreApplication::translate("MainWindow", "Random walk w memory", nullptr));
